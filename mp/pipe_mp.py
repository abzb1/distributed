...
parser.add_argument("-t", "--num-split", default=8, type=int, metavar="N",
                    help="number of microbatch (default: 8)")
...
parser.add_argument("-f", "--prof", default=True, type=bool, metavar="T/F",
                    help="Turn on PyTorch profiler option (default: False)")
parser.add_argument("--balance", default=[13,40], type=list,
