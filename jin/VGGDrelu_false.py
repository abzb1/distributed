...
class vgg16bn_cifar10(torch.nn.Module):
    def __init__(self):
        super(vgg16bn_cifar10, self).__init__()
        self.model = nn.Sequential(OrderedDict([
                        ("block1_conv1", nn.Conv2d(3, 64, 3, padding = 1)),
                        ("block1_conv1_batchnorm", nn.BatchNorm2d(64)),
                        ...
                        ("flatten", nn.Flatten()),
                        ("fc1", nn.Linear(512 * 7 * 7, 4096)),
                        ("fc1_ReLU", nn.ReLU(True)),
                        ("fc1_Dropout", nn.Dropout(0.5)),
                        ("fc2", nn.Linear(4096, 4096)),
                        ("fc2_ReLU", nn.ReLU(True)),
                        ("fc2_Dropout", nn.Dropout(0.5)),
                        ("prediction", nn.Linear(4096, 10))
                        ]))
